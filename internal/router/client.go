...
import (
	...
	"niceBackend/internal/resources/api/article"
	"niceBackend/internal/resources/api/category"
	"niceBackend/internal/resources/api/option"
	"niceBackend/internal/resources/api/tags"
)
