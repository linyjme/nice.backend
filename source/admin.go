...
var admins = []model.SysUser{
	{BASE_MODEL: global.BASE_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, UUID: uuid.NewV4(), Account: "admin", Password: "cm9vdA==", NickName: "超级管理员", HeaderImg: "http://qmplusimg.henrongyi.top/NICE_header.jpg", AuthorityId: "888"},
}
